...
class LongForJobCrawler:
    def __init__(self, output_file: str = "longfor_jobs.json"):
    ...
    async def get_sub_companies(self, page) -> List[Dict[str, Any]]:
        ...
        try:
            # 先访问页面建立会话
            await page.goto(
                "https://longfor.zhaopin.com/sgs/index.html", wait_until="networkidle"
            )
            ...
            payload = {
                ...
                "companyOrDepartmentId": "10126970",
                "format": "tree",
            }
    ...
    def _get_fallback_companies(self):
        """获取备用的公司列表"""
        fallback = [
            {"id": 10126975, "name": "地产开发", "level": "parent"},
            {"id": 10126976, "name": "商业管理", "level": "parent"},
            {"id": 10126977, "name": "资产管理", "level": "parent"},
            {"id": 10126978, "name": "龙湖智创生活", "level": "parent"},
            {"id": 10126979, "name": "龙智造", "level": "parent"},
            {"id": 10126980, "name": "数字科技平台", "level": "parent"},
            {"id": 10126981, "name": "千丁数科", "level": "parent"},
            {"id": 10126982, "name": "职能类", "level": "parent"},
        ]
...
async def main():
    crawler = LongForJobCrawler("longfor_jobs.json")
    await crawler.crawl()
