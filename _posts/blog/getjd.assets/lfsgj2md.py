...
def json_to_markdown(
    input_file: str = "longfor_jobs_dedup.json",
    output_file: str = "longfor_jobs_final.md",
):
    """
    将去重后的JSON转换为Markdown文档
    """
    ...
    print(f"共生成 {len(jobs)} 个岗位条目")


def main():
    # 转换去重后的JSON为Markdown
    json_to_markdown(
        input_file="longfor_jobs_dedup.json", output_file="longfor_jobs_final.md"
    )
